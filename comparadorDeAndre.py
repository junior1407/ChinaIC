...
andre1= cv2.imread('poses/dicaprio1.jpeg', cv2.IMREAD_COLOR)
#andre1= cv2.resize(andre1, (0, 0), fx=0.5, fy=0.5)
andre2= cv2.imread('poses/dicaprio2.jpeg', cv2.IMREAD_COLOR)
...
#dets1 = detector(andre1, 0)
#shape1 = predictor(andre1, dets1[0])
descript1 = facerec.compute_face_descriptor(andre1, shape1, 1)
...
#dets2 = detector(andre2, 1)
#shape2 = predictor(andre2, dets2[0])
descript2 = facerec.compute_face_descriptor(andre2, shape2, 1)
